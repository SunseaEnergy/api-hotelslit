...
async function main() {
  ...
  const categories = await Promise.all(
    [
      { name: 'City', image: 'https://placeholder.com/categories/city.jpg' },
      {
        name: 'Resort',
        image: 'https://placeholder.com/categories/resort.jpg',
      },
      {
        name: 'Beach',
        image: 'https://placeholder.com/categories/beach.jpg',
      },
      {
        name: 'Mountain',
        image: 'https://placeholder.com/categories/mountain.jpg',
      },
      {
        name: 'Luxury',
        image: 'https://placeholder.com/categories/luxury.jpg',
      },
      {
        name: 'Budget',
        image: 'https://placeholder.com/categories/budget.jpg',
      },
      {
        name: 'Business',
        image: 'https://placeholder.com/categories/business.jpg',
      },
      {
        name: 'Boutique',
        image: 'https://placeholder.com/categories/boutique.jpg',
      },
    ].map((cat) =>
